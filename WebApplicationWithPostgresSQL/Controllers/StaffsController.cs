...
namespace WebApplicationWithPostgresSQL.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public StaffsController(BankingContext context)
        {
            _context = context;    
        }
        ...
        {
            var sharpPrgContext = _context.Staff.Include(s => s.StaffBranchNoNavigation);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var staff = await _context.Staff
                .Include(s => s.StaffBranchNoNavigation)
                .SingleOrDefaultAsync(m => m.StaffNo == id);
            if (staff == null)
            {
                return NotFound();
            }
        ...
        {
            ViewData["StaffBranchNo"] = new SelectList(_context.Branch, "BranchNo", "City");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var staff = await _context.Staff.SingleOrDefaultAsync(m => m.StaffNo == id);
            if (staff == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.Staff.Any(e => e.StaffNo == id);
        }
    }
}
