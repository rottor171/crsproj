...
namespace WebApplicationWithPostgresSQL.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(BankingContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var client = await _context.Client
                .SingleOrDefaultAsync(m => m.ClientNo == id);
            if (client == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var client = await _context.Client.SingleOrDefaultAsync(m => m.ClientNo == id);
            if (client == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.Client.Any(e => e.ClientNo == id);
        }
    }
}
